...
Description: This file contains functions to schedule Ecobee thermostats based on Google Calendar events.
             Ecobee modes are assigned depending on these conditions:
                1. “Home” during events
                2. "Away" outside the sleep end and sleep start period defined in the config.json file
                3. "Sleep" within the sleep end and sleep start period defined in the config.json file
"""
import datetime
