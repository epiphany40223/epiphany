...
# the important part.
#
# NOTE: AFTER running this script, you'll have a zillion PDFs.  Angie
# wants to print them all out; the easiest way to do this is to roll
# them all up into a single PDF.  I haven't tried to write this into
# Python, but I found an easy manualy macOS / Preview hack for this:
#
# - Open 1 PDF (e.g., the first one, numerically)
# - Show the navigation thumbnails in the sidebar
# - In Finder, select all the other PDFs
# - Drag-n-drop those PDFs into the navigation thumbnail sidebar of the 1st PDF
# - Save the first PDF
#
# Boom; done.
...
source_google_drive_folder = '1JqXOWqo8vRuipZBkdRtpqx9mKjCv1TrO'
